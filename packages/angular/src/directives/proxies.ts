...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['checked', 'disabled', 'helpText', 'indeterminate', 'label', 'name', 'value'],
  outputs: ['rux-change', 'rux-input', 'rux-blur']
})
export class RuxCheckbox {
  /** Fired when the value of the input changes - [HTMLElement/input_event](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/input_event) */
  rux-change!: EventEmitter<CustomEvent<any>>;
  /** Fired when an alteration to the input's value is committed by the user - [HTMLElement/change_event](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/change_event) */
  rux-input!: EventEmitter<CustomEvent<any>>;
  /** Fired when an element has lost focus - [HTMLElement/blur_event](https://developer.mozilla.org/en-US/docs/Web/API/Element/blur_event) */
  rux-blur!: EventEmitter<CustomEvent<any>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-change', 'rux-input', 'rux-blur']);
  }
}
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['disabled', 'download', 'href', 'rel', 'target', 'value'],
  outputs: ['rux-menu-item-selected']
})
export class RuxMenuItem {
  /** Emitted when item is clicked. Ex `{value : 10}` */
  rux-menu-item-selected!: EventEmitter<CustomEvent<object>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-menu-item-selected']);
  }
}
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['confirmText', 'denyText', 'modalMessage', 'modalTitle', 'open'],
  outputs: ['rux-modal-closed']
})
export class RuxModal {
  /** Event that is fired when modal closes */
  rux-modal-closed!: EventEmitter<CustomEvent<boolean>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-modal-closed']);
  }
}
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['anchorEl', 'open', 'triggerEl'],
  outputs: ['rux-menu-will-open', 'rux-menu-will-close', 'rux-menu-did-open', 'rux-menu-did-close']
})
export class RuxPopUpMenu {
  /** Emitted when the menu is about to open. */
  rux-menu-will-open!: EventEmitter<CustomEvent<void>>;
  /** Emitted when the menu is about to close */
  rux-menu-will-close!: EventEmitter<CustomEvent<void>>;
  /** Emitted when the menu is open. */
  rux-menu-did-open!: EventEmitter<CustomEvent<void>>;
  /** Emitted when the menu is closed. */
  rux-menu-did-close!: EventEmitter<CustomEvent<void>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-menu-will-open', 'rux-menu-will-close', 'rux-menu-did-open', 'rux-menu-did-close']);
  }
}
...
export class RuxPushButton {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-change', 'rux-blur']);
  }
}
...
export class RuxRadio {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-blur']);
  }
}
...
export class RuxRadioGroup {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-change']);
  }
}
...
export class RuxSelect {
  ...
  rux-change!: EventEmitter<CustomEvent<void>>;
  /** Fired when an element has lost focus - [HTMLElement/blur_event](https://developer.mozilla.org/en-US/docs/Web/API/Element/blur_event) */
  rux-blur!: EventEmitter<CustomEvent<any>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
...
export class RuxSlider {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-input', 'rux-blur']);
  }
}
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  outputs: ['rux-register-panels']
})
export class RuxTabPanels {
  /** Emits a list of the Tab Panels that have been passed in */
  rux-register-panels!: EventEmitter<CustomEvent<HTMLRuxTabPanelsElement[]>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-register-panels']);
  }
}
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['small'],
  outputs: ['rux-selected']
})
export class RuxTabs {
  /** Fires whenever a new tab is selected, and emits the selected tab. */
  rux-selected!: EventEmitter<CustomEvent<any>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-selected']);
  }
}
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  inputs: ['expanded', 'selected'],
  outputs: ['rux-tree-node-selected']
})
export class RuxTreeNode {
  /** Emit when user selects a tree node */
  rux-tree-node-selected!: EventEmitter<CustomEvent<string>>;
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['rux-tree-node-selected']);
  }
}
