...
<Meta
    ...
    argTypes={extractArgTypes('rux-input')}
     parameters={{
       actions: {
        handles: ['rux-input rux-input', 'rux-change rux-input', 'rux-blur rux-input'],
      },
    }}
/>
...
export const Types = (args) => {
    ...
    <div class="grid">
      ...
      <rux-input label="Password Input" type="password" placeholder="Reindeer Flotilla"></rux-input>
...
export const HorizontalLabel = (args) => {
    ...
    <style>
      ...
      <rux-input id="left-example" label="Label" type="text" placeholder="Text input"></rux-input>
    `
}
