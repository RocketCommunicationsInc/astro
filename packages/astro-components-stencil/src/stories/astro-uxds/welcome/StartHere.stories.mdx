...
<ul class="frameworks">
  ...
  <li class="framework">
    <a href="?path=/docs/astro-uxds-welcome-angular--page">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 250"><path fill="#dd0031" d="M125 30 31.9 63.2l14.2 123.1L125 230l78.9-43.7 14.2-123.1z"/><path fill="#c3002f" d="M125 30v22.2-.1V230l78.9-43.7 14.2-123.1L125 30z"/><path d="M125 52.1 66.8 182.6h21.7l11.7-29.2h49.4l11.7 29.2H183L125 52.1zm17 83.3h-34l17-40.9 17 40.9z" fill="#fff"/></svg>
      Angular
    </a>
  </li>
 <li class="framework">
...
<li class="framework">
    <a href="?path=/docs/astro-uxds-welcome-vue-2--page">
        <svg viewBox="0 0 261.76 226.69" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="m161.096.001-30.224 52.35L100.647.002H52.346l78.526 136.01L209.398.001z" fill="#34495e" /></svg>
        Vue 2
    </a>
</li>
<li class="framework">
