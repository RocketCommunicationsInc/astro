...
describe('rux-tabs', () => {
    ...
    it('first rux-tab has selected attr by default', async () => {
        ...
        await page.setContent(
            '<rux-tabs id="tab-set-id-1"><rux-tab id="tab-id-1">Tab 1 Title</rux-tab><rux-tab id="tab-id-2">Tab 2 Title</rux-tab></rux-tabs><rux-tab-panels aria-labelledby="tab-set-id-1"><rux-tab-panel aria-labelledby="tab-id-1"></rux-tab-panel></rux-tab-panels>'
        )
