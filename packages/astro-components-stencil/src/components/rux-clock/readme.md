...
| `hideDate`     | `hide-date`     | Hides the day of the year.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `boolean` | `undefined` |
| `hideTimezone` | `hide-timezone` | Hides the timezone in the main 24-hour clock. Timezone does not display on AOS/LOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `boolean` | `undefined` |
| `los`          | `los`           | When supplied with a valid [date string or value](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#syntax), displays a timestamp labeled "LOS" next to the standard clock.                                                                                                                                                                                                                                                                                                                              | `string`  | `undefined` |
| `small`        | `small`         | Applies a smaller clock style.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `boolean` | `undefined` |
