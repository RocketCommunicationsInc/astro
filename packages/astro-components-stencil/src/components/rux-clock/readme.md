...
| `hideDate`     | `hide-date`     | Hides the day of the year.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `boolean \| undefined` | `undefined` |
| `hideTimezone` | `hide-timezone` | Hides the timezone in the main 24-hour clock. Timezone does not display on AOS/LOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `boolean \| undefined` | `undefined` |
