...
import { RuxSegmentedButton, RuxInputField, RuxButton } from '@astrouxds/react'
...
const SegmentedButton = () => {
  ...
  return(
    <div>
      ...
      <RuxInputField
          onRux-change={(e: CustomEvent<HTMLRuxInputFieldElement>) => {
...
This will take the input from RuxInputField and add to the dataArr, thus adding to RuxSegmentedButton and trigerring a re-render.
...
class MyComp extends React.Component {
    ...
    render() {
        return (
            <div>
                <RuxInputField onRux-input={(e) => this.handleInput(e)} />
            </div>
        )
    }
}
...
const MyComp = () => {
    ...
    return (
        <div>
            <RuxInputField
                onRux-input={(e: CustomEvent<HTMLRuxInputFieldElement>) => {
                    const target = e.target as HTMLInputElement
