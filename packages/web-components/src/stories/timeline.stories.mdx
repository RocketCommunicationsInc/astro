...
export const SubTracks= () => {
    return html`
        <div style="padding: 2rem;">
            <iframe src="https://codesandbox.io/embed/timeline-demo-collapse-js-rqf39e?fontsize=14&hidenavigation=1&theme=dark"
...
<Canvas>
    <Story name="SubTracks" args={{expanded: false}}>{SubTracks.bind()}</Story>
</Canvas>
