        ...
        <div style="width: 1050px; margin: auto">
            <rux-timeline timezone="${args.timezone}" start="${start}" end="${end}" playhead="${position}" interval="${args.interval}" zoom="${args.zoom}">
                ...
                <rux-track>
                    ...
                    <rux-time-region start="2021-02-01T10:00:00Z" end="2021-02-01T12:00:00Z">
                        <rux-status status="normal"></rux-status>
                        Event 2.1
                    </rux-time-region>
                </rux-track>
                <rux-track>
                    ...
                    <rux-time-region start="2021-02-01T00:00:00Z" end="2021-02-02T02:00:00Z">
                        <rux-status status="normal"></rux-status>
                        Event 3.1
                    </rux-time-region>
                </rux-track>
                <rux-track>
                    ...
                    <rux-time-region start="2021-02-01T05:00:00Z" end="2021-02-02T05:33:00Z">
                        <rux-status status="normal"></rux-status>
                        Event 4.1
                    </rux-time-region>
                </rux-track>
...
the component will throw an error and not render. A valid `start` and `end` time must fall within the date range specified on the root **Timeline** component
...
```
> NOTE: Editing a Time Region's start or end dates after it has been rendered will not trigger another rerender. If you need to update data, instead remove the `time-region` node entirely and create a new one.
