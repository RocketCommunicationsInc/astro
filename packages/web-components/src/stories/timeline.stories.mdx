...
export const Default = (args) => {
    ...
    if (args.position) {
        position = new Date(args.position).toISOString()
    }
    return html`
        <div style="width: 1050px; margin: auto">
            <rux-timeline .start="${start}" end="${end}" position="${position}" interval="${args.interval}" zoom="${args.zoom}">
                <rux-track>
