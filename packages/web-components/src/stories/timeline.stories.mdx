...
export const StyledDiv = styled.div`
    position: relative;
    margin: 1rem 0;
    border-left: 20px solid var(--color-status-serious-fill);
    background: white;
    color: var(--color-status-serious-fill);
    padding: 19px;
...
export const BetaTag = styled.div`
  ...
  padding: 7px;
  color: var(--color-global-basics-black);
  border-radius: var(--radius-base);
  background: var(--color-global-tag-tag1-300);
