...
By default, Cards have a default padding of 0.625rem (10px) set on the body. If you'd like to change this (for example, using tables or a list inside your Card), you can use the `--body-padding` CSS custom property for convenience or the `body` CSS shadow part.
