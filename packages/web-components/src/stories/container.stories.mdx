...
By default, Containers have a default padding of 1.25rem (20px) set on the body. If you'd like to change this (for example, using tables or a list inside your Container), you can use the `--body-padding` CSS custom property for convenience or the `body` CSS shadow part.
