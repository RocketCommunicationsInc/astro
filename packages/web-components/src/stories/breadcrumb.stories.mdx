...
Unfortunately, React Router's default implementation will not work out of the box. Instead, you'll need to listen on click and manually navigate using [useNavigate](https://reactrouter.com/en/main/hooks/use-navigate)
...
Unfortunately, Angular Router's default implementation will not work out of the box. Instead, you'll need to listen on click and manually navigate. 
