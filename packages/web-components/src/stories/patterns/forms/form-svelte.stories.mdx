...
<iframe
    src="https://codesandbox.io/s/astro-form-in-svelte-hn6m9?file=/Form.svelte"
...
<iframe
    src="https://codesandbox.io/s/astro-form-in-svelte-with-validation-7jk16?file=/Form.svelte"
    class="sandbox"
