...
<Meta
    title="Components/Progress/Indeterminate Progress"
...
In order to re-size `rux-indeterminate-progress`, change the `--size` CSS custom property to you're desired size.
