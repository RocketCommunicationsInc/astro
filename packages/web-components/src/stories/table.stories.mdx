...
If you are looking for a more robust solutuion for tabular data please us [ag-grid](https://next--astro-stencil.netlify.app/?path=/story/themes-ag-grid--ag-grid)
