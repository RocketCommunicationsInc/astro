...
The toast stack component can create toasts via internal method `addToast()`. Toasts created via this method can have their props set via an object passed into the method, and will be automaticaly added to the stack that they were created from.
