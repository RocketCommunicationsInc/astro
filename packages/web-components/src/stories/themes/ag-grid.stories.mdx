...
export const AGGrid = () => {
    return html`
        <div style="padding: 2rem;">
            <iframe
                src="https://codesandbox.io/embed/github/RocketCommunicationsInc/astro/tree/ASTRO-2052-add-ag-grid-story/packages/web-components/src/stories/astro-sandboxes/themes/ag-grid"
                class="sandbox"
