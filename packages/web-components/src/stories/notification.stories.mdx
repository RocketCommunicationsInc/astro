...
<Canvas>
    <Story name="Small" height="100px" args={{ size: "small" }}>
        {Small.bind()}
    </Story>
</Canvas>
    ...
    <section>
     <div class="wrapper">
          ...
          <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="normal">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="caution">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="serious">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="critical">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="standby">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small" status="off">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
        ...
        <div class="wrapper wrapper--small">
            <rux-notification open size="small">
                Notification banner
                <a href="#" style="margin-left: 8px">Link</a>
            </rux-notification>
        </div>
