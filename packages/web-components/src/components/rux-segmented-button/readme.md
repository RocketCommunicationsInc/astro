...
| `size`     | `size`     | Changes size of segmented button from medium to small or large by setting sizing classes rux-segmented-button--small rux-segmented-button--large                                                                                                                                                                                                                                                               | `"large" \| "medium" \| "small" \| undefined` | `undefined` |
