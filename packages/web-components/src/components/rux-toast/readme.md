...
| `customClass` | `custom-class` | Allows rux-toast to be assigned a class when being created programatically through the addToast method. Class names should be separated by a white space.                                                                                                                                                                                                                                                                                                                                      | `string`                                                                              | `''`        |
