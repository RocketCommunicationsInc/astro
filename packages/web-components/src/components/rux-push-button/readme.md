...
| --------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ----------- |
| `activeLabel`   | `active-label`   | Specifies the label text to use if the push button is pushed.                                                                                                                                                                                                                                                 | `string \| undefined`                         | `undefined` |
...
| `inactiveLabel` | `inactive-label` | Specifies the label text to use if the push button is not pushed.                                                                                                                                                                                                                                             | `string \| undefined`                         | `undefined` |
| `label`         | `label`          | The label of the push button.                                                                                                                                                                                                                                                                                 | `string`                                      | `''`        |
